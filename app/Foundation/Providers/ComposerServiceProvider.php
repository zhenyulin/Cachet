...
class ComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot(Factory $factory)
    {
        ...
        $factory->composer(['index', 'single-incident', 'single-schedule', 'subscribe.*', 'signup', 'dashboard.settings.theme', 'notifications::email', 'single-schedule', 'emails.*'], ThemeComposer::class);
